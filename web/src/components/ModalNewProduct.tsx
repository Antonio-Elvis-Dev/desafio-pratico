...
export const ModalNewProduct = ({ isOpen, onClose }: ModalProps) => {
                    ...
                    >
                        <div className="bg-slate-900 px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                            <div className="sm:flex sm:items-start">
                                <div className="mx-auto flex size-12 shrink-0 items-center justify-center rounded-full bg-slate-600 sm:mx-0 sm:size-10">
                                    <PackagePlus/>

                                </div>
                                <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                    <DialogTitle as="h3" className="text-base font-semibold text-slate-100">
                                        Cadastrar Produto
                                    </DialogTitle>
                                    <div className="mt-2">
                                        <FormScreem />
